...
public class State_and_City {
  ...
  public static   List<String> list,city_list, Andhra_Pradesh_list,Arunachal_Pradesh_list,Assam_list,Bihar_list,Chhattisgarh_list,Goa_list,Gujarat_list,  Haryana_list,Himachal_Pradesh_list,JammuAnd_Kashmir_list,Jharkhand_list,Karnataka_list,Madhya_Pradesh_list,Meghalaya_list;
    public static   List<String>  Mizoram_list,Nagaland_list,Kerala_list,Maharashtra_list,Manipur_list,Odisha_list,Pondicherry_list,   Punjab_list,Rajasthan_list,Sikkim_list,Tamil_Nadu_list,Telangana_list,Tripura_list,Uttar_Pradesh_list,Uttarakhand_list,West_Bengal_list;
